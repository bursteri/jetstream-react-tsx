    ...
    <div v-if="providers.length" class="space-y-6 mt-6 mb-2">
        ...
        <div class="grid gap-4">
            <a v-for="provider in providers" :key="provider.id"
               class="flex gap-2 items-center justify-center transition duration-200 border border-gray-400 w-full py-2.5 rounded-lg text-sm shadow-xs hover:shadow-md font-normal text-center inline-block"
